            ...
            <div className="row row5">
              ...
              <div
                onClick={() => {
                  ...
                  setPlaceBetValue({});
                  setPlaceBetValue({
                    price: data[0]?.runners[6]?.back[0]?.price,
                    side: 0,
                    selectionId: data[0]?.runners[6]?.id,
                    btype: data[0]?.btype,
                    eventTypeId: data[0]?.eventTypeId,
                    betDelay: data[0]?.betDelay,
                    marketId: data[0]?.id,
                    back: true,
                    name: data[0]?.runners[6]?.name,
                    isWeak: data[0]?.isWeak,
                  });
                }}
                className={`casino-odds-box back ${
              ...
              >
               {/*    <!-- result0 >> status  --> */}
                  ...
                  <div>
                    <span className="casino-odds">    {data[0]?.runners[6]?.back[0]?.price}</span>
                {/*     <!-- result0 >> runner0 >> back0  --> */}
                <div className="casino-nation-book text-center">
                  <span
                    className={`${
                      zeroIndexSixRunnersEx && zeroIndexSixRunnersEx[0]?.pnl < 0
                        ? "text-danger"
                        : "text-success"
                    }`}
                  >
                    {zeroIndexSixRunnersEx ? zeroIndexSixRunnersEx[0]?.pnl : null}
                  </span>
                </div>
                  </div>
                </div>
