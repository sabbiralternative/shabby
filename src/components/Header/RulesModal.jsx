  ...
  return (
    <>
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="fade rules-modal modal show"
        tabIndex="-1"
        style={{
          display: "block",
        }}
            ...
            <div className="modal-header">
              ...
              <div className="rules-langualge">
                <div className="dropdown">
                  ...
                  >
                    <img src="https://g1ver.sprintstaticdata.com/v8/static/front/img/flags/flag_english.png" />
                    English
                  </button>
                </div>
              </div>
            ...
            <div className="modal-body">
                ...
                <div className="nav nav-pills" role="tablist">
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-0"
                      aria-controls="tules-tabs-tabpane-0"
                      aria-selected="true"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-1"
                      aria-controls="tules-tabs-tabpane-1"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-2"
                      aria-controls="tules-tabs-tabpane-2"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-3"
                      aria-controls="tules-tabs-tabpane-3"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-4"
                      aria-controls="tules-tabs-tabpane-4"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-5"
                      aria-controls="tules-tabs-tabpane-5"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-6"
                      aria-controls="tules-tabs-tabpane-6"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-7"
                      aria-controls="tules-tabs-tabpane-7"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      ...
                      id="tules-tabs-tab-8"
                      aria-controls="tules-tabs-tabpane-8"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="9"
                      id="tules-tabs-tab-9"
                      aria-controls="tules-tabs-tabpane-9"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="10"
                      id="tules-tabs-tab-10"
                      aria-controls="tules-tabs-tabpane-10"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="11"
                      id="tules-tabs-tab-11"
                      aria-controls="tules-tabs-tabpane-11"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="12"
                      id="tules-tabs-tab-12"
                      aria-controls="tules-tabs-tabpane-12"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="13"
                      id="tules-tabs-tab-13"
                      aria-controls="tules-tabs-tabpane-13"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="14"
                      id="tules-tabs-tab-14"
                      aria-controls="tules-tabs-tabpane-14"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="15"
                      id="tules-tabs-tab-15"
                      aria-controls="tules-tabs-tabpane-15"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="16"
                      id="tules-tabs-tab-16"
                      aria-controls="tules-tabs-tabpane-16"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="17"
                      id="tules-tabs-tab-17"
                      aria-controls="tules-tabs-tabpane-17"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="18"
                      id="tules-tabs-tab-18"
                      aria-controls="tules-tabs-tabpane-18"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="19"
                      id="tules-tabs-tab-19"
                      aria-controls="tules-tabs-tabpane-19"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="20"
                      id="tules-tabs-tab-20"
                      aria-controls="tules-tabs-tabpane-20"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="21"
                      id="tules-tabs-tab-21"
                      aria-controls="tules-tabs-tabpane-21"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="22"
                      id="tules-tabs-tab-22"
                      aria-controls="tules-tabs-tabpane-22"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="23"
                      id="tules-tabs-tab-23"
                      aria-controls="tules-tabs-tabpane-23"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="24"
                      id="tules-tabs-tab-24"
                      aria-controls="tules-tabs-tabpane-24"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="25"
                      id="tules-tabs-tab-25"
                      aria-controls="tules-tabs-tabpane-25"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="26"
                      id="tules-tabs-tab-26"
                      aria-controls="tules-tabs-tabpane-26"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="27"
                      id="tules-tabs-tab-27"
                      aria-controls="tules-tabs-tabpane-27"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="28"
                      id="tules-tabs-tab-28"
                      aria-controls="tules-tabs-tabpane-28"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="29"
                      id="tules-tabs-tab-29"
                      aria-controls="tules-tabs-tabpane-29"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="30"
                      id="tules-tabs-tab-30"
                      aria-controls="tules-tabs-tabpane-30"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="31"
                      id="tules-tabs-tab-31"
                      aria-controls="tules-tabs-tabpane-31"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="32"
                      id="tules-tabs-tab-32"
                      aria-controls="tules-tabs-tabpane-32"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="33"
                      id="tules-tabs-tab-33"
                      aria-controls="tules-tabs-tabpane-33"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
                  ...
                  <div className="nav-item">
                    <a
                      role="tab"
                      data-rr-ui-event-key="34"
                      id="tules-tabs-tab-34"
                      aria-controls="tules-tabs-tabpane-34"
                      aria-selected="false"
                      tabIndex="-1"
                      className="nav-link"
                      href="#"
              ...
              <div className="rules-content">
                <div className="tab-content">
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="">
                                  If the match will not take place within 48
                                  hours of the original kick-off time bets will
                                  be void.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  accumulator any refund must be requested
                                  before kick-off of the first leg of the
                                  multiple bet.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Please note that games which have their
                                  kick-off altered well in advance to
                                  accommodate live TV, or to ease fixture
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  walkover victory without the match having
                                  kicked off, then all bets will be void. Any
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  penalty shootouts all count. If a penalty has
                                  to be re-taken the previous disallowed
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  time. Any extra-time and/or penalty shoot-out
                                  is not included. For the cancellation of a
                                  goal, due to VAR, bets matched between the
                                  time of the goal being scored and the time at
                                  which the video assistant referee finishes the
                                  review will be voided. For the cancellation of
                                  a red card, due to VAR, bets matched after the
                                  time at which the video assistant referee
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  starting but not being completed, all bets
                                  will be void, unless the specific market
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  void. If a game is abandoned, bets will be
                                  void.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  teams will score at least one goal in the
                                  game. Own goals count towards the team
                                  credited with the goal. If a game is
                                  abandoned, bets will be void, unless the
                                  outcome of these bets is already determined.
                                  Yes” – meaning that both teams will score.
                                  “No” – meaning that either team will not
                                  score.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  void. For example, game finishes or is
                                  abandoned with 8 corners taken – all bets on
                                  any corner after the 8th will be void (9th,
                                  10th, etc.).
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  will be settled on an even number of goals.
                                  For Team Odd/Even markets, if the specified
                                  team does not score then we will settle on an
                                  even number of goals. In the event of an
                                  abandoned match then bets for that match will
                                  be void.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  1X2 Corners :- Predict which team will get
                                  more corners in a match. Awarded, but not
                                  taken corners (there is a corner, but before
                                  it is taken the referee signals for the end of
                                  the first half or the match) will not count
                                  for settlement purposes. Also if a corner
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  shown in a match. If a player is sent off for
                                  2 yellow cards, this counts as 2 yellow cards
                                  and 1 red card for betting purpose es. If the
                                  match is abandoned for any reason, all bets
                                  will be void unless market is already
                                  determined, e.g. Team 1 over 2,5 yellow cards
                                  - 3 yellow cards awarded to Team 1 before
                                  abandonment is settled as a winner. Cards for
                                  non-players (already substituted players,
                                  managers, players on bench which are not
                                  substituted in) are not considered. Settlement
                                  will be made with reference to all available
                                  evidence to cards shown during the scheduled
                                  90 minutes play. Any card shown after the
                                  full-time whistle blow will be disregarded.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  will be scored in this first half of this
                                  match? All bets apply to Full Time according
                                  to the match officials, plus any stoppage
                                  time. Extra-time/penalty shoot-outs are not
                                  included.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Penalty Taken? :- Will a penalty be awarded
                                  and taken during this match? All bets apply to
                                  Full Time according to the match officials,
                                  plus any stoppage time. Extra-time/penalty
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  match. This market will not be partially
                                  settled during the fixture and will be fully
                                  settled at full time. All bets apply to Full
                                  Time according to the match officials, plus
                                  any stoppage time. Extra-time/penalty
                                  shoot-outs are not included.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Corners Number/Odds : - How many corners will
                                  be taken in the match? Only corners that are
                                  taken will be counted. All bets apply to Full
                                  Time according to the match officials, plus
                                  any stoppage time. Extra-time/penalty
                                  shoot-outs are not included.
                                </span>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Team_A/B +1/2/3 : - Who will win this match
                                  with the stated handicap applied? All bets
                                  apply to Full Time according to the match
                                  officials, plus any stoppage time.
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-1"
                    aria-labelledby="tules-tabs-tab-1"
                      ...
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="text-danger">1.General</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  according to the official result at the time
                                  of the weigh-in announcement (or equivalent).
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  void, or in the event of a walkover, all bets
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Where a race does not take part on its
                                  scheduled day, all bets will be void.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  of odds on bets already matched when a horse
                                  in a race is declared a non-runner. In order
                                  to make the adjustment We applies a reduction
                                  ...
                                  winning (or being placed, etc as appropriate)
                                  and is applied to bets already matched on the
                                  other runners in the relevant market or
                                  markets.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  When the market is loaded each horse is given
                                  a reduction factor, based on a forecast price,
                                  which is expressed as a percentage. These
                                  reduction factors may be updated periodically
                                  at the discretion of Us based on trading in
                                  the market, but after approximately 15 minutes
                                  (approximately 5 minutes for Australian and US
                                  markets) from the scheduled off time of a
                                  given race, they will be updated only in
                                  exceptional circumstances. The current
                                  reduction factor percentage for each horse can
                                  be viewed on the info page on Our website or
                                  by asking the Helpdesk.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Accurate reduction factors will only be
                                  applied to selections in the event of a
                                  non-runner. Once a non-runner is declared each
                                  selection in the market will be given an
                                  appropriate reduction factor. Reduction
                                  factors can be amended at Our’s discretion at
                                  any time throughout the market life cycle
                                  (including post-race).
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  For Australian racing, reduction factors may
                                  be updated periodically at the discretion of
                                  Us based on trading in the market, but after
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  All matched bets on that horse will be void
                                  and the horse will be removed from the market.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  horses will be reduced by an amount equal to
                                  the non-runners final reduction factor and all
                                  the unmatched offers to lay will be cancelled.
                                  If the non-runners reduction factor is less
                                  than 2.5%, reductions will not be applied and
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  In the place market the reduction factor of
                                  all non-runners will be applied (even if less
                                  than 2.5%) and the potential winnings in
                                  relation to matched bets on the remaining
                                  horses will be reduced by an amount equal to
                                  the non-runners final reduction factor. Only
                                  if the non-runners reduction factor is 4.0% or
                                  greater will all the unmatched offers to lay
                                  be cancelled.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Reduction factors are not applied to bets
                                  which are struck in-play. However, if a market
                                  is turned in-play prematurely by error (or,
                                  for example, there is a false start), all bets
                                  matched during this time will be subject to
                                  any later reduction factor, provided the
                                  market is turned out of play before the race
                                  commences. In the event of a late withdrawal,
                                  We reserves the right to remove the runner
                                  after completion of the race. In this case
                                  only those bets matched prior to the off will
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  In the event of a non-runner being removed
                                  from a race in error or following incorrect
                                  information regarding a runner’s
                                  ...
                                  reinstatement will be void in both the place
                                  market and the win market. The reduction
                                  factor applied to matched bets at the time of
                                  withdrawal will be reversed and the original
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  relevant markets in the order in which they
                                  are brought to Ours attention. If We becomes
                                  aware of more than one non-runner at the same
                                  time, it will remove the non-runners from the
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  If a runner is not included in a market
                                  because of an error or because of incorrect
                                  information regarding a runner’s
                                  participation, We reserve the right to
                                  introduce the missing runner into the market
                                  at any time prior to settlement (even after
                                  the race has been run), provided that We are
                                  determined that the missing runner is not a
                                  material runner (i.e. a selection with a
                                  reduction factor of approx. 2.5% or less in
                                  the win market). In such circumstances, all
                                  pre-play unmatched and matched bets will
                                  stand, however if the runner is not introduced
                                  before the start of the race, all in-play bets
                                  will be void. However, if the missing runner
                                  is deemed to be a material runner, then the
                                  malformed market will be void and a new market
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  In the EW Market, reductions will be made on
                                  the traded win price. The advertised place
                                  terms will then apply to the revised win
                                  prices. For example: if the non-runners final
                                  reduction factor is 25% the traded price on
                                  all previously matched bets on other horses
                                  will be reduced by 25% - - traded price of 8.0
                                  would become 6.0. If the each Way terms were
                                  1/5th odds for 3 places, the corresponding
                                  price for the Place portion of the bet would
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  In the place market, reductions will be made
                                  to the potential winnings on the bet only, and
                                  not the traded price. For example: if the
                                  non-runners final reduction factor is 25% the
                                  potential winnings on all previously matched
                                  bets on the other horses will be reduced by
                                  25% - a traded price of 8.0 would become 6.25.
                                  For example a £10 bet on a horse to be placed
                                  at a traded price of 8.0 would provide
                                  winnings of £70. If there is a non-runner with
                                  a reduction factor of 25% in the race, that
                                  factor will be applied to the £70 of potential
                                  winnings leaving potential winnings of £52.50.
                                  Therefore the revised traded price will be
                                  6.25.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  non-runner, however odds cannot be reduced
                                  below 1.01.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  relevant markets but will have a
                                  non-applicable reduction factor until we are
                                  received confirmation that it is a confirmed
                                  runner, in which case an applicable reduction
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  For the avoidance of doubt, any reduction
                                  factor applicable to a non-runner replaced by
                                  a reserve, will be applied to all bets struck
                                  on the relevant markets, prior to the removal
                                  from those markets of such non-runner by Us.
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Where any horse(s) runs for purse money only
                                  it is deemed a non-runner for betting
                                  purposes. Should this result in the number of
                                  possible winners stated in the relevant Market
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-2"
                    aria-labelledby="tules-tabs-tab-2"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-3"
                    aria-labelledby="tules-tabs-tab-3"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Quarter Winner :- The quarter must be
                                  completed for bets to have action, unless
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  stand. If a game is postponed or cancelled
                                  after the start, for game and second half bets
                                  there must be 5 minutes or less remaining for
                                  bets to have action, unless settlement of bets
                                  is already determined. (Including Overtime if
                                  played.)
                                </span>
                              </td>
                            </tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-4"
                    aria-labelledby="tules-tabs-tab-4"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-5"
                    aria-labelledby="tules-tabs-tab-5"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-6"
                    aria-labelledby="tules-tabs-tab-6"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  completed bets will be void. Exceptions are
                                  made for bets on sets which are already over,
                                  in this case the bets will be settled.
                                </span>
                              </td>
                            </tr>
                            <tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-7"
                    aria-labelledby="tules-tabs-tab-7"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-8"
                    aria-labelledby="tules-tabs-tab-8"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="">
                                  Match Odds :- If 1st set has been not
                                  completed at the time of the retirement or
                                  disqualification, then all bets relating to
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Game Winner :- Predict which player will win
                                  the stated game. The nominated game will be
                                  featured in the name of the bet type, for
                                  example: 2ndset – 7 th game – Winner. If a
                                  game is not completed for any reason, bets on
                                  it will be void. Tie break points will not be
                                  counted for this bet type. unless the specific
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  stake back if I placed a bet on O/U 10.5 (it
                                  is undecided, the set could have ended 6-4).
                                </span>
                              </td>
                            </tr>
                            <tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-9"
                    aria-labelledby="tules-tabs-tab-9"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-10"
                    aria-labelledby="tules-tabs-tab-10"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-11"
                    aria-labelledby="tules-tabs-tab-11"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-12"
                    aria-labelledby="tules-tabs-tab-12"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-13"
                    aria-labelledby="tules-tabs-tab-13"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-14"
                    aria-labelledby="tules-tabs-tab-14"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-15"
                    aria-labelledby="tules-tabs-tab-15"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-16"
                    aria-labelledby="tules-tabs-tab-16"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-17"
                    aria-labelledby="tules-tabs-tab-17"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Bet will be settled on regulation time only
                                  and exclude overtime if played:
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  time. If a game is abandoned, bets will be
                                  void. Example: If you choose 1/X, you bet on
                                  the home team to lead in the first half and
                                  the match to end in a draw. Extra time doesn’t
                                  count.
                                </span>
                              </td>
                            </tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-18"
                    aria-labelledby="tules-tabs-tab-18"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">bookmaker</div>
                    <div className="rules-content-desc">
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  We will simply compare both teams 25 overs
                                  score higher score team will be declared
                                  winner in ODI (25 over comparison)
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  T20 matches (10 over comparison)
                                </span>
                              </td>
                            </tr>
                            <tr>
                      ...
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">1 Session:-</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  3.5 Test match both advance fancy batsmen run
                                  is valid.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Retired out means partnership will continued
                                  in next batsman.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  4.4 Test match both advance fancy partnership
                                  is valid.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  In partnership one batsman is injured or
                                  Retired out means partnership will continued
                                  in next batsman.
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span className="">Both innings are valid</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  if he havent completed the over. For example B
                                  Kumar is bowling his final over and at 3.4 the
                                  match has resulted then result will be given
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">World Cup:-</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  16.Our exchange is not responsible for misuse
                                  of client id.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Byes &amp; Leg byes runs will not be counted
                                  in bowler Session.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Hitting the ball in Zone A (the front net,
                                  i.e., the net behind the wicket keeper) wont
                                  get you any bonus runs.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  between the bowlers end and halfway), you
                                  score 2 bonus runs.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Hitting the ball in Zone D (the back net,
                                  i.e., the net behind the bowler) allows you to
                                  score 4 or 6 bonus runs depending on how the
                                  ball hits the back net. If the ball hits the
                                  net after bouncing, you get 4 bonus runs. If
                                  the ball hits the net without bouncing on the
                                  ground, you score 6 bonus runs.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Remember that at least one physical run must
                                  be taken for any bonus runs to be scored.
                                  Whatever bonus runs you get will be added to
                                  the physical runs. For example, if you strike
                                  the ball into the front net for 1 bonus run
                                  and take 2 physical runs, you score a total of
                                  3 runs off the ball.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">10 over a-side innings</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  allowed beyond the Inner box marking. After
                                  the end of power play over, only 2 players can
                                  be outside the Inner Box.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  take a physical run if they want, if no
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  If the player hits the net after the middle
                                  line (Zone C) its 2 bonus runs. (only taken
                                  into consideration if the players take a
                                  physical run)
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  line (Zone B) its 1 bonus run. (only taken
                                  into consideration if the players take a
                                  physical run)
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  If the ball goes straight to the boundary
                                  (Zone D) without a bounce, it’s a SIX.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  If the ball hits the upper net and goes
                                  straight to the boundary (Zone D) it’s a 6.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  goes straight to the boundary (Zone D) it’s a
                                  4.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  hits or touches the Side Nets of that
                                  particular zone (B&amp;C) and taken into
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  they do so it will be counted as a no ball and
                                  2 runs will be given to the batting team and
                                  the ball will not be counted.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  delivery will not be counted and each wide or
                                  no ball will be given 2 runs to the batting
                                  team total.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  If the batsman is a right hander and if the
                                  ball goes out of the white wide line it will
                                  be given as a wide ball &amp; if the ball is
                                  going leg side and is inside the Leg Side line
                                  the ball is counted.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  counted as a no ball, but the batter has to
                                  play the ball from the crease, in case the
                                  batter is outside the crease and plays the
                                  ball it will be termed as a good ball.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  If the batsman does not hit the ball after it
                                  is bowled it is considered as a Dot Ball, the
                                  batsman gets 0 runs.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  If the batsman hits the ball and the fielders
                                  or the wicket-keeper catch it without it
                                  touching the floor, the batsman will be
                                  dismissed as Catch Out.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  If the ball touches a fielder and then hits
                                  the nets (zones), the bonus runs will be
                                  counted, if the physical runs are taken by the
                                  batter.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">No runs for overthrow.</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  and bonus runs are applicable if physical run
                                  is taken.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  If the ball touches the bonus run zones and
                                  the fielder accomplishes a run out, the batter
                                  will be OUT and no bonus runs will be counted.
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  to go back to strike to face the next ball.
                                  Run out for the runner will mean dismissal for
                                  the last batsman.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Settlement occurs once the stipulated
                                  conditions are met, which involves either
                                  completion of the allotted overs or the
                                  batting teams dismissal, including weather
                                  disturbances.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  result. For limited overs matches, this
                                  includes results determined by the Duckworth
                                  Lewis method.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  concerns, stadium damage, acts of terrorism,
                                  or acts of God, the company holds the
                                  authority to nullify all bets, with the
                                  exception of those related to markets that
                                  have already been conclusively settled.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  scorecard updates, inaccurate commentary,
                                  delays in suspending the Bhav Bets of Total
                                  Innings Runs market, or erroneous updates of
                                  rates and odds for Bhav Bets in Total Innings
                                  Runs will be removed and deleted from user
                                  accounts.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Match 30s : If a Player reached 50
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  If World Cup fixture of 48 matches gets
                                  reduced due to any reason, then all the
                                  special fancies will be voided (Match
                                  abandoned due to rain/bad light will not be
                                  considered in this)
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Match 1st over runs : Average 4 runs
                                  will be given in case match abandoned or over
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Wides - Average 16 Wides will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Total No balls:- Average 2 No ball will be
                                  given in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total 100s - Average 1 Hundred will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Maidens - Average 4 Maidens will be
                                  given in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Boundaries Given by an Individual Bowler in
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Most Dotballs By a Bowler in the Match :
                                  Maximum Dotballs Bowled by an Individual
                                  Bowler in his Quota of any Single Match
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Most Wickets by a Bowler in the Match :
                                  Maximum Wickets Given by an Individual Bowler
                                  in his Quota of any Single Match
                                </span>
                              </td>
                            </tr>
                            <tr>
                    ...
                    <div className="rules-content-title">fancy1</div>
                    <div className="rules-content-desc">
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  1. The team which is favourite at lunch will
                                  be considered as lunch favourite or the team
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  2. In any circumstances management decision
                                  will be final.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  team which favourite at lunch will be
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  5.1 For example :- in T20 match rain comes at
                                  14 over and match is interrupted due to rain
                                  and direct target is given to 2nd batting
                                  team, then team which is favourite in match
                                  odds after target is given in match, will be
                                  considered as lunch favourite.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  series will postponed or cancelled then at
                                  that moment result will be given to difference
                                  of opening rate to present rate.
                                </span>
                              </td>
                            </tr>
                            <tr>
                    ...
                    <div className="rules-content-title">cricket casino</div>
                    <div className="rules-content-desc">
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  other penalty run will not be counted in game
                                  of our exchange.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="text-danger">
                                  3. In any circumstances management decision
                                  will be final.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Ind : 45 run &amp; 83 run respectively , so
                                  the result will be given as 53 for double last
                                  digit game in our exchange.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  respectively so the result will be given as
                                  305 for triple last digit game in our
                                  exchange.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  respectively so the result will be given as
                                  307 for triple last digit game in our
                                  exchange.
                                </span>
                              </td>
                            </tr>
                      ...
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="text-danger">IPL</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours - Average 25 fours will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Total Sixes - Average 10 sixes will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Bowled out - Average 2 bowled out will
                                  be given in case match abandoned or over
                                  reduced
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Highest match 1st over run in individual
                                  match: Only 1st inning will be considered as
                                  valid valid
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="text-danger">
                                  All events related to bowler are valid only
                                  for the league stages, both the innings will
                                  be considered as valid. A minimum of 32 overs
                                  has to be bowled else the same will be voided.
                                  If the mentioned bowler has bowled one legal
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">
                                  All events based on ground are decided based
                                  on the initial fixture, in case of any changes
                                  in the venue between the series. Then average
                                  will be given based on the initial fixture for
                                  the number of games reduced, Similarly if any
                                  match is added newly to the venue will not be
                                  considered
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="text-danger">
                                  ...
                                  case match abandoned or over reduced or the
                                  player has not bowled single legal delivery
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  given if total 20 overs is not played, only
                                  1st innings will be considered as valid
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours - Average 28 fours will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Total Sixes - Average 11 Sixes will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours - Average 24 fours will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="text-danger">QUEENSLAND</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours - Average 27 fours will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours - Average 26 fours will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Total Sixes - Average 12 Sixes will be given
                                  in case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Extras - Average 16 Extras will be given in
                                  case match abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  will be given in case of match abandoned or
                                  the entire 50 over is not played.
                                </span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Fours:- Average 48 Fours will be given
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Total Caught Out:- Average 10 Caught Out will
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  1. In case any player mentioned in our world
                                  cup fancy got ruled out or doesn’t play post
                                  few matches the bets after the last match
                                  played by the above mentioned player will be
                                  deleted. For example: U Khawaja played for
                                  first three league matches and doesn’t play
                                  after that, then bets for the first three
                                  matches will be valid. Bets after third match
                                  will be deleted.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  3. Total runs by team:- Average will be given
                                  if the match is abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  4. First 10 over runs by team:- Average will
                                  be given if the match is abandoned or over
                                  reduced
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  5. Fours by team:- Average will be given if
                                  the match is abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  6. Sixes by team:- Average will be given if
                                  the match is abandoned or over reduced
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  7. Opening wicket partnership:- Average will
                                  be given if the match is abandoned or over
                                  reduced
                                </span>
                              </td>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  8. Runs by player:- Average will be given if
                                  the match is abandoned or over reduced,
                                  Average will be given unless one ball is being
                                  played after the player enters the crease
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  9. Wickets by player:- Average will be given
                                  if the match is abandoned or over reduced,
                                  Average will be given unless one legal
                                  delivery has been bowled by the mentioned
                                  player.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  How many matches win by a team : Only valid
                                  for league stage matches. Ex. For CSK, How
                                  many matches CSK win during league stages only
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Tournament. Ex. Last Season (2021) R Gaikwad
                                  Hit 64 Fours in 16 Matches. So, 64 was the
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  Most 4s by an individual batsman in an Inning
                                  of IPL : Maximum Number of Fours Hit By A
                                  Batsman in one Innings. Ex. Last Season (2021)
                                  S Yadav Hit 13 Fours in 55th league Match. So,
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Tournament. Ex. Last Season (2021) KL Rahul
                                  Hit 30 Sixes in 13 Matches. So, 30 was the
                                  Result for last season.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  in one Innings. Ex. Last Season (2021) K
                                  Pollard Hit 8 Sixes in 27th league Match. So,
                                  8 was the Result for last season.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  overs of 27th Match. So, 62 was the Result for
                                  last season.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Bowler in an Innings. Ex : Last Season (2021)
                                  H Patel taken 5 wickets in 1st Match. So, 5
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  Maximum Number of Fifties Hit By A Batsman in
                                  full Tournament. Ex. Last Season (2021) Faf
                                  duPlessis Hit 6 fifties in 16 Matches. So, 6
                                  was the Result for last season.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  Highest total runs in individual match of IPL
                                  : Maximum total runs of both Teams in
                                  individual match. Ex . Last Season (2021) RR
                                  vs PBKS match both teams Total runs 438 (4th
                                  League Match) . So, 438 was the Result for
                                  Last Season.
                                </span>
                              </td>
                            </tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-19"
                    aria-labelledby="tules-tabs-tab-19"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">fancy</div>
                    <div className="rules-content-desc">
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  will be valid in our exchange ,The customers
                                  are entirely responsible for their bets at all
                                  times.
                                </span>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  the same not to be legitimate with the
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  will not be counted in our exchange If
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  partially settled and will remain in the
                                  market until it is fully settled. This is to
                                  ensure that all customers can continue trading
                                  for the candidates that they have positions
                                  on, since each candidate is still a valid
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-20"
                    aria-labelledby="tules-tabs-tab-20"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-21"
                    aria-labelledby="tules-tabs-tab-21"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-22"
                    aria-labelledby="tules-tabs-tab-22"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-23"
                    aria-labelledby="tules-tabs-tab-23"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-24"
                    aria-labelledby="tules-tabs-tab-24"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-25"
                    aria-labelledby="tules-tabs-tab-25"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-26"
                    aria-labelledby="tules-tabs-tab-26"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-27"
                    aria-labelledby="tules-tabs-tab-27"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  match. In the event of a match starting but
                                  not being completed the player progressing to
                                  the next round or being awarded the victory
                                  will be deemed the winner for settlement
                                  purposes. In the event of a match not starting
                                  at all, all bets are refunded.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  nominated frame is awarded to a player without
                                  a shot being played, then all bets will be
                                  void.
                                </span>
                              </td>
                            </tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-28"
                    aria-labelledby="tules-tabs-tab-28"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-29"
                    aria-labelledby="tules-tabs-tab-29"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-30"
                    aria-labelledby="tules-tabs-tab-30"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-31"
                    aria-labelledby="tules-tabs-tab-31"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">fancy</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-32"
                    aria-labelledby="tules-tabs-tab-32"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-33"
                    aria-labelledby="tules-tabs-tab-33"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td>
                                <span className="">
                                  Match odds :- Predict which player will win
                                  the match. In the event of any of the named
                                  players in a match changing before the match
                                  starts then all bets are void. In the event of
                                  a match starting but not being completed, all
                                  bets will be void.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  completed for bets to stand, unless the
                                  specific market outcome is already determined.
                                </span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  the game would have yielded at least 18
                                  points.
                                </span>
                              </td>
                            </tr>
                  ...
                  <div
                    role="tabpanel"
                    id="tules-tabs-tabpane-34"
                    aria-labelledby="tules-tabs-tab-34"
                    className="fade tab-pane"
                  >
                    <div className="rules-content-title">match</div>
                    <div className="rules-content-desc">
                            ...
                            <tr>
                              <td>
                                <span className="">
                                  ...
                                  the end of the 1 st half. In the event of a 1
                                  st half not being completed bets will be void.
                                </span>
                              </td>
                            </tr>
                            <tr>
