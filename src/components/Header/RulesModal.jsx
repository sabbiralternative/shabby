    ...
    >
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
                    ...
                    <div className="table-responsive">
                      <table className="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">2 Odi rule:-</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">Other fancy:-</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">Game Format :</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                    ...
                    <div className="table-responsive">
                      <table className="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <span className="">Common Means Only 1 Win</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div className="table-responsive">
                      <table className="table table-bordered">
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">Adelaide Oval</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">Perth Stadium</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">Sydney Ground</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span className="text-danger">WC:-WORLD CUP</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
          ...
          <div onClick={()=> setRuleModal(!ruleModal)} className="modal-footer">
