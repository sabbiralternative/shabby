...
const StateProvider = ({ children }) => {
  ...
  const stateInfo = {
    ...
    eightIndexFiveRunnersEx, setEightIndexFiveEx,
    eightIndexFourRunnersEx, setEightIndexFourEx,
    eightIndexThreeRunnersEx, setEightIndexThreeEx,
    eightIndexTwoRunnersEx, setEightIndexTwoEx,
    eightIndexOneRunnersEx, setEightIndexOneEx,
    eightIndexZeroRunnersEx, setEightIndexZeroEx,
    sevenIndexTwelveRunnersEx, setSevenIndexTwelveEx,
    sevenIndexElevenRunnersEx, setSevenIndexElevenEx,
    sevenIndexTenRunnersEx, setSevenIndexTenEx,
    sevenIndexNineRunnersEx, setSevenIndexNineEx,
    sevenIndexEightRunnersEx, setSevenIndexEightEx,
    sevenIndexSevenRunnersEx, setSevenIndexSevenEx,
    sevenIndexSixRunnersEx, setSevenIndexSixEx,
    sevenIndexFiveRunnersEx, setSevenIndexFiveEx,
    sevenIndexFourRunnersEx, setSevenIndexFourEx,
    sevenIndexThreeRunnersEx, setSevenIndexThreeEx,
    sevenIndexTwoRunnersEx, setSevenIndexTwoEx,
    sevenIndexOneRunnersEx, setSevenIndexOneEx,
    sevenIndexZeroRunnersEx, setSevenIndexZeroEx,
    sixIndexOneRunnersEx, setSixIndexOneEx,
    sixIndexZeroRunnersEx, setSixIndexZeroEx,
    fiveIndexOneRunnersEx, setFiveIndexOneEx,
    fiveIndexZeroRunnersEx, setFiveIndexZeroEx,
    fourIndexOneRunnersEx, setFourIndexOneEx,
    fourIndexZeroRunnersEx, setFourIndexZeroEx,
    jqkExposure, setJqkExposure,
    eight910Exposure, setEight910Exposure,
    four56Exposure, setFour56Exposure,
    a23Exposure, setA23Exposure,
    blackExposure, setBlackExposure,
    redExposure, setRedExposure,
    oddExposure, setOddExposure,
    evenExposure, setEvenExposure,
    zeroIndexFiveRunnersEx, setZeroIndexFiveEx,
    zeroIndexFourRunnersEx, setZeroIndexFourEx,
    zeroIndexThreeRunnersEx, setZeroIndexThreeEx,
    zeroIndexTwoRunnersEx, setZeroIndexTwoEx,
    zeroIndexSixRunnersEx, setZeroIndexSixEx,
    highExposure, setHighExposure
   ,tenIndexZeroRunnersEx, setTenIndexZeroEx,elevenIndexZeroRunnersEx, setElevenIndexZeroEx,twelveIndexZeroRunnersEx, setTwelveIndexZeroEx,thirteenIndexZeroRunnersEx, setThirteenIndexZeroEx,fourteenIndexZeroRunnersEx, setFourteenIndexZeroEx,fifteenIndexZeroRunnersEx, setFifteenIndexZeroEx,sixteenIndexZeroRunnersEx, setSixteenIndexZeroEx,seventeenIndexZeroRunnersEx, setSeventeenIndexZeroEx
